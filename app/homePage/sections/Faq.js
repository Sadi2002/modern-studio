...
export default function Faq() {
  ...
  return (
    <section className="mx-margin-mobile flex flex-col md:mx-tablet  lg:mx-small-laptop mb-[40px] lg:mb-[80px] xl:mb-[150px]">
      ...
      <div className="border-t-[1px] border-t-[rgba(0,0,0,0.2)]  lg:w-[85%] xl:w-[70%] 2xl:w-[75%]">
        {faq.map((step, index) => {
          ...
          return (
            ...
            >
              <span className="block text-[clamp(16px,4.5vw,20px)] font-light-font-weight leading-[clamp(0.75rem,10vw,2rem)]">
                {step.title}
              </span>
              {isOpen && (
