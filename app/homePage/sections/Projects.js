      ...
      <div className="flex flex-col lg:flex-row lg:justify-between">
        ...
        <div className="lg:flex lg:flex-col lg:w-[calc(50%-10px)]">
          ...
          <div className="leading-[26px] flex flex-col gap-[40px] items-end lg:gap-[30px]">
            <p className="self-start text-[clamp(14px,3.5vw,18px)] leading-[clamp(20px,6vw,24px)] min-[900px]:max-w-[750px] lg:ml-10 lg:leading-[36px] md:leading-[28px] md:max-w-[600px] font-light-font-weight xl:max-w-[570px] xl:text-[23px] xl:leading-[36px] 2xl:text-[26px] 2xl:leading-[42px] 2xl:max-w-[800px]">
