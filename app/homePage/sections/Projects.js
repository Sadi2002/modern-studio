    ...
    <section className="mx-margin-mobile md:mx-tablet lg:mx-small-laptop mb-[50px]">
      ...
      <div className="flex flex-col lg:flex-row lg:justify-between">
        ...
        <div className="flex flex-col lg:w-[calc(50%-10px)]">
          ...
          <div className="max-w-[80%] mb-[50px] lg:mb-[30px] lg:max-w-[100%]">
            <div className="relative aspect-8/7 overflow-hidden">
              <ProgressiveImageHighQuality
                smallSrc="/projekt2-small.jpg"
                largeSrc="/projekt2-large.jpg"
                alt="projekt 2"
                aspectRatio="8/7"
              />
            </div>
          ...
          {/* Projekt 4 */}
          <div className="w-[86%] flex flex-col items-end self-end mb-[50px] lg:mb-0 lg:w-[100%] lg:h-full">
            <div className="flex flex-col justify-end w-full relative aspect-5/3 overflow-hidden lg:h-full">
              <ProgressiveImageHighQuality
                smallSrc="/projekt4-small.jpg"
                largeSrc="/projekt4-large.jpg"
                alt="projekt 4"
                aspectRatio="5/3"
              />
            </div>
        ...
        <div className="lg:flex lg:flex-col lg:w-[calc(50%-10px)]">
          ...
          <div className="w-full-width mb-[50px] lg:mb-[30px]">
            <div className="relative aspect-8/5 overflow-hidden">
              <ProgressiveImageHighQuality
                smallSrc="/projekt3-small.jpg"
                largeSrc="/projekt3-large.jpg"
                alt="projekt 3"
                aspectRatio="8/5"
              />
            </div>
          ...
          <div className="max-w-[78%] mb-[30px] lg:w-[100%] lg:max-w-[100%] lg:mb-[60px]">
            <div className="relative aspect-7/8 overflow-hidden lg:aspect-8/7">
              <ProgressiveImageHighQuality
                smallSrc="/projekt1-small.jpg"
                largeSrc="/projekt1-large.jpg"
                alt="projekt 1"
                aspectRatio="7/8"
              />
            </div>
