  ...
  return (
    <section className="flex flex-col gap-[40px] lg:gap-0 lg:flex-row w-full lg:items-center lg:mt-[100px] lg:h-[calc(100dvh-100px)]">
      <div className="flex-1 pt-[100px] md:pt-[150px] lg:pt-0 mx-margin-mobile md:mx-tablet lg:ml-[50px] 2xl:mx-[50px]">
        <h1 className="text-[clamp(1.5rem,8vw,3rem)] leading-[clamp(2.2rem,10vw,3.5rem)] uppercase font-medium mb-[20px] max-w-[500px] xl:max-w-[700px] lg:text-[45px] lg:leading-[45px] lg:max-w-[500px] lg:w-[100%] xl:text-[60px] xl:leading-[60px]  2xl:text-[80px] 2xl:leading-[80px] lg:font-normal 2xl:max-w-[75%]">
          {title}
        </h1>
