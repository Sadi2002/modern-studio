    ...
    <section className="pt-[100px] md:pt-[150px] lg:pt-[100px] w-screen mb-[40px] md:mb-[40px] lg:mb-[80px] relative ">
      ...
      <div className="lg:flex lg:justify-between lg:items-center">
        <div className="px-[20px] lg:pt-[100px] md:px-[40px] lg:px-[50px] lg:max-w-[700px]  2xl:max-w-[850px] 2xl:pl-[50px]">
          <h1 className="text-[clamp(30px,8vw,45px)] uppercase leading-[clamp(36px,8vw,45px)] font-medium mb-[20px] xl:mb-[20px] max-w-[500px] lg:text-[45px] lg:leading-[45 px] lg:max-w-[500px] lg:w-[100%] xl:text-[60px] xl:leading-[60px] xl:max-w-[600px] 2xl:max-w-[1200px] lg:font-normal 2xl:text-[80px] 2xl:leading-[80px] 2xl:w-[750px]">
            {data?.title?.[lang]}
          </h1>
