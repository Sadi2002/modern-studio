...
export default function Delivers() {
  return (
    <section className="lg:border-t lg:border-[rgba(0,0,0,0.2)] pt-[40px] lg:pt-[100px] w-screen mb-[80px] md:mb-[80px] lg:mb-[80px] xl:mb-[150px] relative flex justify-between">
      ...
      <div className="w-[60%] lg:w-[50%] lg:flex lg:items-end gap-[20px] px-[20px] md:px-[40px] lg:px-[50px] hidden">
        <div className="w-[35%] h-[200px] lg:h-[100px] xl:h-[120px] 2xl:h-[200px] lg:w-[40%] relative aspect-8/7 overflow-hidden self-end">
          <Image
