  ...
  return (
    <section className="px-[20px] pt-[100px] md:px-[40px] md:pt-[150px] 2xl:pt-[200px] lg:px-[50px] mb-[80px] xl:mb-[150px] relative">
      <div className="flex flex-col gap-[40px] justify-start lg:flex-row lg:justify-between lg:items-center lg:mb-[80px] xl:mb-[150px]">
        <div>
          <h1 className="text-[clamp(30px,8vw,45px)] leading-[clamp(36px,8vw,45px)] uppercase font-medium mb-[20px] max-w-[600px] md:max-w-[700px] lg:text-[45px] lg:leading-[45px] lg:max-w-[650px] lg:w-[100%] xl:max-w-[700px] xl:text-[60px] xl:leading-[60px] 2xl:max-w-[870px] 2xl:text-[80px] 2xl:leading-[80px]  lg:font-normal">
